...
with open("designs/index.html", "r", encoding="utf-8") as f:
    content = f.read()
...
with open("designs/index.html", "w", encoding="utf-8") as f:
    f.write(content)
print("Injected Music Lounge into designs/index.html!")
